...
##print(Angry_birds.storyline)


Logan = media.Movie("Logan",
                    "Logan is a 2017 American superhero film featuring the Marvel Comics character Wolverine, produced by Marvel Entertainment, TSG Entertainment, and The Donners' Company,and distributed by 20th Century Fox. It is the tenth installment in the X-Men film series,as well as the third Wolverine solo film following X-Men Origins: Wolverine (2009) and The Wolverine (2013), and also potentially being a reboot set in a continuity different from that of previous films. The film takes inspiration from Old Man Logan by Mark Millar and Steve McNiven, which follows an aged Wolverine undertaking a final adventure in a dystopian future.",
...
##John_Wick_chapter_2.show_trailer()


The_Lost_City_of_Z = media.Movie("The Lost City of Z",
                                 ...
                                 "https://youtu.be/teUMcu6p9o0")
##The_Lost_City_of_Z.show_trailer()
...
The_Glass_Castle = media.Movie("The Glass Castle",
...
Despicable_Me_3 = media.Movie("Despicable Me 3",
                             "Despicable Me 3[a] is a 2017 American 3D computer-animated comedy film produced by Illumination Entertainment for Universal Pictures. It is the third installment in the Despicable Me film series, and the sequel to Despicable Me 2 (2013). The film is directed by Pierre Coffin and Kyle Balda, co-directed by Eric Guillon,[6] and written by Cinco Paul and Ken Daurio.In the film, Gru teams up with his long lost twin brother Dru in order to defeat a new enemy named Balthazar Bratt, a 1980s child actor who grows up to become a villain. Steve Carell, Miranda Cosgrove and Dana Gaier reprise their roles of Gru, Margo and Edith from the first two films, and Julie Andrews who returns as Marlena, Gru's mother from Despicable Me (2010). Kristen Wiig and Steve Coogan return from Despicable Me 2 and Trey Parker, Jenny Slate and Nev Scharrel (replacing Elsie Fisher as Agnes) join the cast. Despicable Me 3 premiered on June 14, 2017 at the Annecy International Animated Film Festival, and was released in the United States on June 30, 2017 by Universal Pictures. The film received mixed reviews from critics[7] and has grossed over $825 million worldwide, making it the fourth highest grossing film of 2017.movies = [Wonder_Woman, Angry_birds, Logan, John_Wick_chapter_Two, The_Lost_City_of_Z, BABY_DRIVER, The_Glass_Castle]details_website.open_movies_page(movies)",
...
Resident_Evil_Vendetta = media.Movie("Resident Evil:Vendetta",
                                     "Resident Evil: Vendetta, known as Biohazard: Vendetta (バイオハザード ヴェンデッタ Baiohazādo Vendetta) in Japan, is a 2017 Japanese 3D animated action-adventure horror thriller film. It is part of the Resident Evil franchise, set in the same universe as the associated video games (unlike the live action films starring Milla Jovovich). The film features the characters Chris Redfield, Leon S. Kennedy and Rebecca Chambers.[1] It is the third CG movie, after Resident Evil: Degeneration in 2008, followed by Resident Evil: Damnation in 2012, and this film marks the third with Leon as a main character. The film is produced by Marza Animation Planet,[2] written by Makoto Fukami (Psycho-Pass) and directed by Takanori Tsujimoto (The Next Generation: Patlabor, Ultraman X).[3] Takashi Shimizu will serve as executive producer. The film was released in Japan on May 27, 2017,[3] while a limited theatrical showing in United Kingdom took place on June 14, 2017[4] and North America is planned for June 19, 2017. The movie became available in North America across digital retailers on June 20 and on Blu-ray and DVD July 18",
                                     "https://upload.wikimedia.org/wikipedia/en/b/ba/Resident_Evil_Vendetta_poster.jpeg",
                                     "https://www.youtube.com/watch?v=Fs5g-l0Bcss")
Smurfs_The_Lost_Village = media.Movie("Smurfs: The Lost Village",
                                      "Smurfs: The Lost Village is a 2017 American 3D computer-animated comedy-adventure film produced by Sony Pictures Animation and The Kerner Entertainment Company, with animation by Sony Pictures Imageworks, for Columbia Pictures.[1][6] Sony, LStar Capital and Wanda Pictures co-financed the film.[6][7][8] It is based on The Smurfs comic book series created by the Belgian comics artist Peyo, and is a reboot unrelated to Sony's previous live-action/animated films based on the series. It was written by Stacey Harman and Pamela Ribon and directed by Kelly Asbury,[1] and stars the voices of Demi Lovato, Rainn Wilson, Joe Manganiello, Mandy Patinkin, Jack McBrayer, Danny Pudi, Michelle Rodriguez, Ellie Kemper, Ariel Winter, Meghan Trainor, Jake Johnson and Julia Roberts. In the film, a mysterious map prompts Smurfette, Brainy, Clumsy and Hefty to find a lost village before Gargamel does",
...
The_Lego_Batman_Movie = media.Movie("The Lego BATMAN Movie",
                                    ...
                                    "https://www.youtube.com/watch?v=kvgHOAOiAuY")
movies = [Wonder_Woman, Angry_birds, Logan, John_Wick_chapter_2, The_Lost_City_of_Z, BABY_DRIVER, The_Glass_Castle, Despicable_Me_3, The_Boss_Baby, Resident_Evil_Vendetta, Smurfs_The_Lost_Village, The_Lego_Batman_Movie]
details_website.open_movies_page(movies)
